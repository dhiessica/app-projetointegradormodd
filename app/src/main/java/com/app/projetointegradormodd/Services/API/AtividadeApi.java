...
public class AtividadeApi {
    ...
    public interface ConexaoListner{
        ...
        void onAsyncObject(Atividade response);
        void onAsyncObjectList(ArrayList<Atividade> response);
    }

    public AtividadeApi(ConexaoListner conexaoListner) {
        this.conexaoListner = conexaoListner;
    }

    public void create(String id, Atividade atividade){
        ...
        classeAssincrona.execute(baseUrl+"createAtividade","POST",id,json);
    }
    ...
    public void update(String id, Atividade atividade){
        ...
        //Chama a classe assincrona passando os parâmetros para execução do request
        classeAssincrona.execute(baseUrl+"updateAtividade","PUT",id,json);
    ...
    public void getList(String id){
        ...
        AsyncClass classeAssincrona = new AsyncClass(new AsyncClass.ConexaoListner() {
            ...
            public void onConexaoFinalizada(JSONObject object) {
                ...
                try{
                    ...
                    JSONArray jsonArray = object.getJSONArray("atividades");
                    ...
                    for (int i=0; i< jsonArray.length(); i++){
                        ...
                        Gson gson = new Gson();
                        Atividade atividade = gson.fromJson(String.valueOf(item), Atividade.class);
                        list.add(atividade);
        ...
        //Chama a classe assincrona passando os parâmetros para execução do request
        classeAssincrona.execute(baseUrl+"getAtividadeList","GET",id);
    }
    ...
    public void get(String id){
        ...
        AsyncClass classeAssincrona = new AsyncClass(new AsyncClass.ConexaoListner() {
            ...
            public void onConexaoFinalizada(JSONObject object) {
                ...
                try{
                    ...
                    JSONObject data = object.getJSONObject("atividade");

                    Gson gson = new Gson();
                    Atividade atividade = gson.fromJson(String.valueOf(data), Atividade.class);
                    conexaoListner.onAsyncObject(atividade);
        ...
        //Chama a classe assincrona passando os parâmetros para execução do request
        classeAssincrona.execute(baseUrl+"getAtividade","GET",id);
    }
    ...
    public void delete(String id){
        ...
        //Chama a classe assincrona passando os parâmetros para execução do request
        classeAssincrona.execute(baseUrl+"deleteAtividade","DELETE",id);
