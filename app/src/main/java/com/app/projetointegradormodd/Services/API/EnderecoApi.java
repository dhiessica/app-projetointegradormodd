...
public class EnderecoApi {
    ...
    public interface ConexaoListner{
        ...
        void onAsyncObject(Endereco response);
    }

    public EnderecoApi(ConexaoListner conexaoListner) {
        this.conexaoListner = conexaoListner;
    }

    public void create(String id, Endereco endereco){
        ...
        classeAssincrona.execute(baseUrl+"createEndereco","POST",id,json);
    }
    ...
    public void update(String id, Endereco endereco){
        ...
        //Chama a classe assincrona passando os parâmetros para execução do request
        classeAssincrona.execute(baseUrl+"updateEndereco","PUT",id,json);
    ...
    public void get(String id){
        ...
        AsyncClass classeAssincrona = new AsyncClass(new AsyncClass.ConexaoListner() {
            ...
            public void onConexaoFinalizada(JSONObject object) {
                ...
                try{
                    ...
                    JSONObject data = object.getJSONObject("endereco");

                    Gson gson = new Gson();
                    Endereco endereco = gson.fromJson(String.valueOf(data), Endereco.class);
                    conexaoListner.onAsyncObject(endereco);
        ...
        //Chama a classe assincrona passando os parâmetros para execução do request
        classeAssincrona.execute(baseUrl+"getEndereco","GET",id);
    ...
    public void delete(String id){
        ...
        //Chama a classe assincrona passando os parâmetros para execução do request
        classeAssincrona.execute(baseUrl+"deleteEndereco","DELETE",id);
